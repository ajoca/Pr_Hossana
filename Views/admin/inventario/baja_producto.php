    ...
    <div class="row">
        ...
        function eliminar() {
            var respuesta = confirm(
                "Estas seguro que desea eliminar?                                                            (El producto se eliminara de forma permanente)."
            )
            return respuesta
        }
        </script>
        ...
        include "../../../Controller/baja_producto.php"; 
        ?>
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover display nowrap" style="width: 100%;"
                            ...
                            <tbody>
                                <?php include '../../../Controller/lista_productos_baja.php' ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return activar()"
                                            href="baja_producto.php?id=<?php echo $row['id_producto']?>&activo=1&nombre=<?php echo $row['nombre']?>"
                                            class="btn btn-small btn-info"><i class="fa-solid fa-trash-can"></i>Activar
                                        </a>
                                    </td>
                                    <td>
                                        <a onclick="return eliminar()"
                                            href="baja_producto.php?id=<?php echo $row['id_producto']?>&eliminar=0&nombre=<?php echo $row['nombre']?>"
