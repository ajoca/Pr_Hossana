            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                        ...
                        <a href="../../../pdf/generar_pdf.php? echo $row['id_venta'] ?>&v=<?php echo $id_usuario_info ?>&estado=1" target=" _blank" class="btn btn-primary"><i class="fas fa-file-pdf"></i>Informe General</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped table-hover display nowrap" style="width: 100%;" id="tblUsuarios">
                            ...
                            <tbody>
                                <?php include "../../../Controller/informe_ventas.php"; ?>
