...
<div class="container">
    <div class="row">
        ...
        <script>
        function activar() {
            var respuesta = confirm("Estas seguro que desea reactivar?")
            return respuesta
        }

        function eliminar() {
            var respuesta = confirm(
                "Estas seguro que desea eliminar?                                                            (El usuario se eliminara de forma permanente)."
                )
            return respuesta
        }
        </script>
        <div class="col-md-12">
            <a href="../inventario/panel_control.php" class="btn btn-outline-danger mb-3" type="button"
                id="btnNuevo">Regresar</a>
            <?php 
                include "../../../Controller/eliminar_usuario.php";
                include "../../../Controller/baja_usuario.php";
                include '../../../Controller/lista_usuarios_baja.php';
            ?>
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover display nowrap" style="width: 100%;"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $estado?></td>
                                    <td>
                                        <a onclick="return activar()"
                                            href="lista_bajas_usuarios.php?id=<?php echo $row['id_usuario']?>&estado=1"
                                            class="btn btn-small btn-info"><i class="fa-solid fa-trash-can"></i>Activar
                                        </a>
                                    </td>
                                    <td>
                                        <a onclick="return eliminar()"
                                            href="lista_bajas_usuarios.php?id=<?php echo $row['id_usuario']?>&eliminar=0"
                                            class="btn btn-small btn-danger"><i class="fa-solid fa-trash-can"></i>Eliminar
                                        </a>
                                    </td>
                                </tr>
                                <?php } ?>
